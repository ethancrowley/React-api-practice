...
"# React-api-practice"    git init   git add README.md   git commit -m "first commit"   git remote add origin git@github.com:ethancrowley/React-api-practice.git   git push -u origin master 
